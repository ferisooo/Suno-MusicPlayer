...
`;
  ...
  // renderer/app.jsx
  var { useState: useState2, useEffect: useEffect2, useRef, useCallback: useCallback2 } = React;
  ...
  function TitleBar({ collapsed, onToggle }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "titlebar" }, /* @__PURE__ */ React.createElement("button", { className: "rail-btn", title: collapsed ? "Show list" : "Hide list", onClick: onToggle }, collapsed ? "\u25B6" : "\u25C0"), /* @__PURE__ */ React.createElement("div", { className: "brand" }, /* @__PURE__ */ React.createElement("span", { className: "heart" }, "\u2665"), " Suno Kawaii Player"), /* @__PURE__ */ React.createElement("div", { className: "spacer" }), /* @__PURE__ */ React.createElement("div", { className: "win-btns" }, /* @__PURE__ */ React.createElement("button", { className: "win-btn", title: "Minimize", onClick: () => api2.minimize() }, "\u2014"), /* @__PURE__ */ React.createElement("button", { className: "win-btn", title: "Maximize", onClick: () => api2.maximize() }, max ? "\u2750" : "\u25A2"), /* @__PURE__ */ React.createElement("button", { className: "win-btn close", title: "Close", onClick: () => api2.close() }, "\u2715")));
  }
